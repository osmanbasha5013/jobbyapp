...
class AboutJobItem extends Component {
    ...
    if (jobDataDetails.length > 1) {
      ...
      return (
        <>
            ...
            <div className="first-part-container">
              ...
              <div className="location-package-container">
                <div className="location-job-type-container">
                  ...
                  <div className="employment-icon-employment-type-container">
          ...
          <h1 className="similar-job-heading">Similar Jos</h1>
  ...
  renderJobLoadingView = () => (
    <div className="job-details-loader" data-testid="loader">
      <Loader type="ThreeDots" color="#0070c0" height="50" width="50" />
    </div>
  )
